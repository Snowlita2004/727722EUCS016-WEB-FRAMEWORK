...
public class angelChildren {
     ...
     public angelChildren() {

     }

     public angelChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
